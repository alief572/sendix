...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('cycletime/add') ?>" class="btn btn-md btn-success" id='btn-add'>
			...
			<tbody>
				...
				foreach ($result as $key => $value) { $key++;
					...
					echo "<tr>";
						...
						echo "<td class='text-center'>".number_format($value['diameter'])."</td>";
						echo "<td class='text-center'>PN ".$value['pressure']."</td>";
						echo "<td class='text-center'>".$value['liner']."</td>";
						echo "<td class='text-center'>".number_format($value['mp'])."</td>";
						echo "<td class='text-center'>".number_format($value['ct'],2)."</td>";
						echo "<td class='text-center'>".number_format($value['mh'],2)."</td>";
