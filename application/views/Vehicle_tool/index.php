...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('vehicle_tool/add') ?>" class="btn btn-md btn-success" id='btn-add'>
	...
	<div>
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#man_power" class='man_power' aria-controls="man_power" role="tab" data-toggle="tab">Tools</a></li>
					...
					<table class="table table-bordered table-striped" id="my-grid" width='100%'>
						<thead>
							<tr class='bg-purple'>
								...
								<th class="text-center">Tools Equipment</th>
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/data_side_vehicle_tool',
				type: "post",
				data: function(d){
