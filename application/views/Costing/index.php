		...
		<table class="table table-bordered table-striped" id="my-grid" width='100%'>
			<thead>
				<tr class='bg-purple'>
					...
					<th class="text-center">Lcation</th>
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url +active_controller+'/data_side_costing',
				type: "post",
				data: function(d){
	...
	$(document).on('click', '.reject', function(){
		...
		swal({
		  title: "Are you sure?",
		  text: "Back to engineering this data ?",
		  type: "warning",
		  showCancelButton: true,
		  confirmButtonClass: "btn-danger",
		  confirmButtonText: "Yes, Process it!",
		...
		function(isConfirm) {
			if (isConfirm) {
				loading_spinner();
				$.ajax({
					url			: base_url+active_controller+'/back_to_engineering/'+project_code,
					type		: "POST",
					cache		: false,
					dataType	: 'json',
					processData	: false,
