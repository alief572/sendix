...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('price/add_vt') ?>" class="btn btn-md btn-success" id='btn-add'>
		...
		<table class="table table-bordered table-striped" id="my-grid" width='100%'>
			<thead>
				<tr class='bg-purple'>
					...
					<th class="text-center no-sort">Price Ref</th>
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url +'index.php/'+active_controller+'/getDataJSON_vt',
				type: "post",
				data: function(d){
    ...
    var unit	= $(this).data('unit');
		...
		function(isConfirm) {
			if (isConfirm) {
				loading_spinner();
				$.ajax({
					url			: base_url+'index.php/'+active_controller+'/hapus_vt/'+id+'/'+unit,
					type		: "POST",
					cache		: false,
					dataType	: 'json',
					processData	: false,
