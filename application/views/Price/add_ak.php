      ...
      foreach($unit AS $val => $valx){
		...
		<div class="box-body">
			<div class='form-group row'>
				<label class='label-control col-sm-2'><b>Akomodasi <span class='text-red'>*</span></b></label>
				<div class='col-sm-4'>
          <?php
					if(empty($kode)){
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl		= base_url + active_controller +'/add_ak';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
