...
<div class="box box-primary">
	<div class="box-header">
		...
		?>
		  <a href="<?php echo site_url('heavy_equipment/add') ?>" class="btn btn-md btn-success" id='btn-add'>
	...
	<div>
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#man_power" class='man_power' aria-controls="man_power" role="tab" data-toggle="tab">Heavy Equipment</a></li>
...
<script>
	...
	function DataTables(){
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax":{
				url : base_url + active_controller+'/data_side_heavy_equipment',
				type: "post",
				data: function(d){
